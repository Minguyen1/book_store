...
@section('content')
    <div class="container mt-4">
        <h2>Sửa sản phẩm</h2>
        <form action="{{ route('admin.updateProduct', $book) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <textarea name="description" style="resize: none; height: 160px;" class="form-control">{{ old('description', $book->description) }}</textarea>
            </div>
